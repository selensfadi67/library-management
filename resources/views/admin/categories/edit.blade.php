...
@section('header', __('messages.edit_category'))
...
<div class="kt-section__content">
    <div class="kt-portlet">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                <h3 class="kt-portlet__head-title">
                    {{ __('messages.edit_category') ?? 'Edit Category' }}: {{ $category->name }}
                </h3>
            </div>
        ...
        <div class="kt-portlet__body">
            <form action="{{ route('admin.categories.update', [$lang, $category]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-8">
                        ...
                        @if($category->books->count() > 0)
                            <div class="form-group">
                                <div class="alert alert-warning">
                                    ...
                                    {{ __('messages.category_has_books') ?? 'This category contains books. Changing the name will affect all associated books.' }}
                                </div>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <h4 id="preview-name" class="text-primary">{{ $category->name }}</h4>
                        ...
                        <div class="card mt-3">
                            <div class="card-header">
                                <h5 class="card-title">{{ __('messages.category_stats') ?? 'Category Statistics' }}</h5>
                            </div>
                            <div class="card-body">
                                <div class="row text-center">
                                    ...
                                    <div class="col-6">
                                        <h4 class="text-success">{{ $category->books->sum('price') }}</h4>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="la la-save"></i> {{ __('messages.update') ?? 'Update Category' }}
                    </button>
                    <a href="{{ route('admin.categories.index', $lang) }}" class="btn btn-secondary">
